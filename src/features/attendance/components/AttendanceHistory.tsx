...
import { IconCalendar, IconSearch, IconClock, IconMapPin, IconDownload, IconFilter, IconHistory } from '@tabler/icons-react';
...
export function AttendanceHistory() {
  ...
  const exportAttendanceHistory = async () => {
    try {
      const csvContent = [
        ['Employee Name', 'Email', 'Position', 'Department', 'Date', 'Check-in Time', 'Check-out Time', 'Status', 'Hours Worked'].join(','),
      ...
      a.setAttribute('download', `attendance_history_${format(dateRange.from, 'yyyy-MM-dd')}_to_${format(dateRange.to, 'yyyy-MM-dd')}.csv`);
